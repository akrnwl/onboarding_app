...
class _PostPageState extends State<PostPage> {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      Date = DateFormat('yyyy.mm.dd').format(response!.list[index].createdAt);
      print(response!.list);
      setState(() {
    ...
    return isLoading
        ...
        : response == null
            ...
            : Scaffold(
                ...
                appBar: Focusheader(name: response!.list[index].title),
                body: Center(
                  child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text(
                                response!.list[index].createdBy.nickname,
                                style: const TextStyle(
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              borderRadius:
                                  BorderRadius.circular(10), // 이미지의 모서리를 둥글게 설정
                              child: Assets.images.eximage.image(
